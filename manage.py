...
from trafidemo.app import create_app
from trafidemo.database import db
from trafidemo.settings import DevConfig, ProdConfig
from trafidemo.user.models import User

CONFIG = ProdConfig if os.environ.get('TRAFIDEMO_ENV') == 'prod' else DevConfig
